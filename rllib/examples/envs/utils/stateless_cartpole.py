...
class StatelessCartPole(CartPoleEnv):
    ...
    def __init__(self, config=None):
        ...
        # Modify our observation-space (remove 2 velocity components).
        high = np.array(
            [
                self.x_threshold * 2,
    ...
    def step(self, action):
        ...
        # next_obs is [x-pos, x-velocity, angle, angle-velocity]
    ...
    def reset(self, *, seed=None, options=None):
        ...
        # init_obs is [x-pos, x-velocity, angle, angle-velocity]
